    ...
    extends Service
{
    ...
    public ExchangeRatesService(WebServiceFeature... features) {
        super(__getWsdlLocation(), EXCHANGERATES_QNAME, features);
    }

    public ExchangeRatesService(URL wsdlLocation) {
        super(wsdlLocation, EXCHANGERATES_QNAME);
    }

    public ExchangeRatesService(URL wsdlLocation, WebServiceFeature... features) {
        super(wsdlLocation, EXCHANGERATES_QNAME, features);
    }

    public ExchangeRatesService(URL wsdlLocation, QName serviceName) {
        super(wsdlLocation, serviceName);
    }

    public ExchangeRatesService(URL wsdlLocation, QName serviceName, WebServiceFeature... features) {
